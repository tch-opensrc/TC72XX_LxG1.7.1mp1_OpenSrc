...
#if defined(CONFIG_BMIPS5000) || defined(CONFIG_BMIPS4350)
#include <asm/brcmstb/brcmapi.h>
#endif
#if defined(CONFIG_BMIPS4350)
extern unsigned long brcm_setup_ebase(void);
#endif
#endif
...
void __init trap_init(void)
{
...
#elif defined(CONFIG_BCM_VECTOR)
		ebase = 0x84000000;
#else
		ebase = CAC_BASE;
#endif
    ...
    {
#if (defined(CONFIG_BCM93383) && !defined(CONFIG_BCM_VECTOR))
