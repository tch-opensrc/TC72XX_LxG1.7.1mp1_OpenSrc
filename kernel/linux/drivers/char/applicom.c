...
/* $Id: applicom.c,v 1.2 2014/11/19 09:13:08 wtchen Exp $			     */
...
static int __init applicom_init(void)
{
	...
	printk(KERN_INFO "Applicom driver: $Id: applicom.c,v 1.2 2014/11/19 09:13:08 wtchen Exp $\n");
...
{				/* @ ADG ou ATO selon le cas */
	...
	case 5:
		...
		break;
	case 6:
		printk(KERN_INFO "APPLICOM driver release .... V2.8.0 ($Revision: 1.2 $)\n");
